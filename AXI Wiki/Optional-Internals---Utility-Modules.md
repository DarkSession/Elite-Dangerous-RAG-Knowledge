# Optional Internals & Utility Modules

Published: On the AXI wiki (https://wiki.antixenoinitiative.com/en/internals)
...
They are not recommended for solo Interceptor fights, as caustic missiles can be avoided using cold mechanics.
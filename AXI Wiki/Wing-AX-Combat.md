...
Published: On the AXI wiki (https://wiki.antixenoinitiative.com/en/wing-combat)
...
1. Post Heart Procedures

- **Get and Stay Cold,** or over 3 km from the Thargoid, to avoid triggering caustic missiles and shutdown fields (see bypass mechanics). Keep hearts in mind. After the first hear, the Tharoid will attempt a lightning chase. After the 2nd to final hear, the Thargoid will look for ship signatures to deploy a shutdown field upon.
...
- Enable the “port forwarding” method as opposed to using UPnP: Ultimate Port Forwarding Guide from MGram

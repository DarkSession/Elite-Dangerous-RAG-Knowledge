...
Published: On the AXI wiki (https://wiki.antixenoinitiative.com/en/hyperdictions)
...
2. Collect a Thargoid Sensor (Also tested Probes and the Proximity Scan from the sensor)
3. Jump 100 times between the same two systems in the Pleiades (Results: ~20 Hyperdictions)
4. To further confirm the Hyperdiction rate, CMDR Maligno has done over ~500 Jumps around these regions and found a very constant rate of ~20% per jump (once ‘marked’)
